...
import { SectionLayout } from '../../(root)/components/navigations/sectionLayout';
      ...
      <div className="max-w-sm mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full px-6 py-3 rounded-lg bg-primary text-white font-medium transition-all ${
