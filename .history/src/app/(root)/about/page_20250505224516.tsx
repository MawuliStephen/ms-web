...
export default function AboutPage() {
  ...
  return (
    <div>
      {/* Download Controls */}
      <div className="no-print sticky top-20 z-20 bg-background/80 backdrop-blur-sm p-4 border-b">
      ...
      {/* Printable Content */}
      <div ref={printRef} className="print:p-8 space-y-10 print:space-y-6">
