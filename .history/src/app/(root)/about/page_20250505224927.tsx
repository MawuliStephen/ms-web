...
export default function AboutPage() {
  ...
  return (
    <div>
      {/* Download Controls */}
      <div className="flex justify-center no-print sticky my-6 mt-20 z-30 bg-background/80 backdrop-blur-sm p-4 border-b">

        <div className=" mx-auto flex flex-wrap justify-end gap-3">
          <Button
          ...
          <PrintButton
            componentRef={printRef}  // No type assertion needed
