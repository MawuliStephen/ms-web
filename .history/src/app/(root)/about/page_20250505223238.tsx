    ...
    <div>
      ...
      <div className="no-print sticky top-0 z-10 bg-background/80 backdrop-blur-sm p-4 border-b">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-end gap-3">
          ...
          ype 'RefObject<HTMLDivElement | null>' is not assignable to type 'RefObject<HTMLDivElement>'.
...
print-button.tsx(16, 3): The expected type comes from property 'componentRef' which is declared here on type 'IntrinsicAttributes & PrintButtonProps'
(property) PrintButtonProps.componentRef: RefObject<HTMLDivElement>
        </div>
