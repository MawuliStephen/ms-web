...
export default function AboutPageContent() {
    ...
    // Ensure all state is updated before printing
const [isReady, setIsReady] = useState(false);

useEffect(() => {
  // Load any async data first
...
if (!isReady) return <Loading />;
    ...
    // Verify ref on mount and updates
    useEffect(() => {
        console.log('Print ref updated:', printRef.current);
        if (printRef.current) {
            console.log('Content length:', printRef.current.innerText.length);
        }
    }, [printRef.current]);
        ...
        <div>
            ...
            <div className="flex justify-center no-print sticky my-6 mt-20 z-10 bg-background/80 backdrop-blur-sm p-4 border-b">
                ...
                <div className=" mx-auto flex flex-wrap justify-center gap-3">
                    ...
                    <PrintButton componentRef={printRef}  // No type assertion needed            documentTitle={filteredContent[activeFilter].title}
                    />
