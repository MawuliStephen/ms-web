...
export default function TechStackSection() {
  return (
    <SectionLayout id="tech-stack">
      <SectionHeader
        title="Tech Stack"
        description="I am proficient in a variety of technologies and tools that help me build efficient and scalable solutions."
      />
        ...
        {techStack.map((tech, index) => (
          ...
          >
            <img 
              ...
              loading="lazy"
            />
            <p className="text-sm font-medium dark:text-foreground">{tech.name}</p>
          </div>
        ))}
      </div>
    </SectionLayout>
