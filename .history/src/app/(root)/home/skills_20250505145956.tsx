...
import ProjectCard from './project-card'; // Adjust the path based on your file structure
...
const SkillsSection = () => {
          ...
          {skills.map((skill) => (
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-md transition-all duration-300 ${
                skill === selectedSkill
                  ? 'border border-primary text-primary dark:text-primary-light hover:bg-primary/10'
  ...
  // return (
  //   <section 
  //     className="relative py-12 text-center  section-background dark:bg-dark-background text-gray-500 dark:text-foreground transition-colors duration-300"  id="skills"
  //   >
  ...
  //       {/* Section header */}
  //       <div className="mb-16">
  //         <div className="flex flex-col space-y-2 mb-8 text-muted-foreground">
  //           {[...Array(1)].map((_, i) => (
  //             <hr key={i} className="border-t-3 " />
  //            ))}
