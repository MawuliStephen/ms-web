    ...
    <div className="min-h-screen">
      ...
      >
        <div className="text-center">
          <SectionHeader 
            title="My Blog" 
            description="Insights on software engineering, design, and business strategy"
          ...
          <div className="relative max-w-md mx-auto mt-8">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-3 rounded-full bg-white/10 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 backdrop-blur-sm"
              value={searchQuery}
      ...
      <SectionLayout id="blog-content" className="py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPosts.map((post) => (
            <article 
              key={post.id} 
              className="bg-surface rounded-lg shadow-sm hover:shadow-md transition-shadow border border-border"
            >
        ...
        <div className="text-center mt-12">
          <button className="px-6 py-2.5 border border-primary text-primary rounded-full hover:bg-primary/10 transition-colors">
            Load More Articles
          </button>
        </div>
      </SectionLayout>
