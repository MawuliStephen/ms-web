...
export default function Blog() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Hero Section */}
            <section className="relative bg-gradient-to-r from-teal-600 to-teal-800 text-white py-20 px-4">
                <div className="max-w-7xl mx-auto text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-6">Next.js Blog</h1>
                    <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-8">
                        Cutting-edge content about web development and design
                    </p>
                    <div className="relative max-w-md mx-auto">
                        ...
                        <input
                            ...
                            className="block w-full pl-10 pr-3 py-3 rounded-full text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        />
                    </div>
                </div>
            </section>
