...
export async function Metadata() {
    return generatePageMetadata({
      title: 'Mawuli Stephen | About Me',
      description: 'Learn more about Mawuli Stephen, a software engineer and marketing professional with over 10 years of experience.',
