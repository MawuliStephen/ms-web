how do we ensure that we make the metadata so that we can use it on separate pages with specific info?
'use client';
...
const IndexPage = () => {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Mawuli Stephen | Home",
    "description": "Welcome to Mawuli Stephen’s homepage! Explore my expertise in software development, marketing, and creative solutions for businesses.",
    "url": "https://www.mawulistephen.com",
    "image": "https://www.mawulistephen.com/images/home-og-image.jpg",
  };
