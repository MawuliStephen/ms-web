      ...
      <div className=" w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-28 lg:py-36">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-center lg:text-left">
            {/* <span className="inline-block text-sm font-medium text-primary bg-primary/10 px-4 py-1 rounded-full">
              New Feature
            </span> */}
            {/* <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight">
              An <span className="text-primary">Experience</span> Software Engineer <br /> & Marketing Expert
            </h1> */}
            ...
            {/* <h1 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight">
              An <span className="bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">Experience</span> Software Engineer <br />
              & <span className="bg-gradient-to-r from-blue-500 to-teal-400 bg-clip-text text-transparent">Marketing</span> Expert
            </h1> */}
            ...
            {/* <p className="text-lg text-muted-foreground max-w-xl mx-auto lg:mx-0">
              With over 10 years of combined experience in software development and marketing,
              I craft solutions that drive results for businesses and people.
            </p> */}
            <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
              <button className="bg-primary text-white px-6 py-3  hover:bg-primary/90 transition">
                About Me
              </button>
              <button className="px-6 py-3 border border-muted  hover:border-primary transition">
                We Can Talk
              </button>
            </div>
          </div>
